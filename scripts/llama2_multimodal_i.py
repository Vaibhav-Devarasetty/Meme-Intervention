...
class MemesDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #input_text = str(self.data["meme_text"][idx]) + " attack_type: " + str(self.data["attack_type"][idx]) + " intervention: " + str(self.data["interventive_content"][idx]) + " " + str(self.data["interventive_filler"][idx])
        input_text = str(self.data["meme_text"][idx]) + " intervention: " + str(self.data["interventive_content"][idx]) + " " + str(self.data["interventive_filler"][idx])
